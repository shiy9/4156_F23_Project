...
/**
 * The custom TokenFilter that processes all passed-through requests. doFilterInternal is
 * overridden to perform token authentication as well as to handle unknown endpoints.
 */
@Component
