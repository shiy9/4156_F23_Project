...
public final class UserMessages {
    ...
    public static final String INVALID_PASSWORD = "Password must contain at least 8 characters, one letter, and one number";
    ...
    // TESTING stuff
    public static final String TEST_DELETE_SUCCESS = "Accounts generated during testing deleted successfully";
    public static final String TEST_DELETE_FAILED = "Failed to delete accounts generated during testing";
